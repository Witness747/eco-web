...
const API_URL = import.meta.env.VITE_API_URL || "https://eco-web-production.up.railway.app";
  ...
  async function fetchProducts(category) {
    ...
    try {
      const url = category === "all"
        ? `${API_URL}/api/shopping-gallery`
        : `${API_URL}/api/shopping-gallery?category=${category}`;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <p style={{
            ...
            fontSize: "17px", color: "#085041", lineHeight: 1.3,
          }}>Eco-Friendly Shopping Gallery</p>
          <p style={{
            margin: 0, fontSize: "13px", color: "#0F6E56",
            marginTop: "2px",
          }}>
      ...
      <div style={{ position: "relative", marginBottom: "14px" }}>
        <span style={{
          ...
          transform: "translateY(-50%)", fontSize: "14px", opacity: 0.4,
        }}>🔍</span>
        <input
          type="text"
          ...
          style={{
            ...
            fontSize: "13px", background: "var(--color-background-primary)",
        ...
        {CATEGORIES.map(cat => (
          <button
            ...
            style={{
              ...
              color: activeCategory === cat.key ? "#085041" : "var(--color-text-secondary)",
              fontFamily: "'DM Sans', sans-serif",
              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: eco.bg, display: "flex",
                  ...
                  <span style={{
                    ...
                    borderRadius: "20px",
                    background: eco.bg, color: eco.text,
                    border: `0.5px solid ${eco.border}`,
                    fontWeight: 500,
                  }}>
                ...
                {isExpanded && (
                  <div style={{
                    ...
                    <a
                      href={`https://www.amazon.in/s?k=${encodeURIComponent(product.name)}+eco`}
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={e => e.stopPropagation()}
                      style={{
